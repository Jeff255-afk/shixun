import sys
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QTextEdit, QGroupBox, QFormLayout
...
class App(QWidget):
    ...
    def on_scan_click(self):
        ...
        self.scanner_thread = PortScanner(host, (start_port, end_port))
